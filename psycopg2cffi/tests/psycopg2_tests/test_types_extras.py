...
class RangeTestCase(unittest.TestCase):
    ...
    def test_ordered(self):
        from psycopg2.extras import Range
        self.assertLess(Range(empty=True), Range(0,4))
        self.assertGreater(Range(0,4), Range(1,2))
        #TODO: Psycopg and Psycopg2cffi Incorrectly Fails here
        self.assertLessEqual(Range(empty=True), Range(1,2))
        self.assertGreaterEqual(Range(), Range(1,2))
